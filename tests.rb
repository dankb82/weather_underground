...
class WeatherUnderground < Minitest::Test
  ...
  def test_alerts
    a = Alert.new(50301)
    assert_equal "FLO", a.type
    assert_equal "Flood Warning", a.description
    assert_equal "3:32 PM CST on February 22, 2016", a.date
    assert_equal "6:00 AM CST on February 26, 2016", a.expires
